...
public class AutoCam : PivotBasedCameraRig
{
    ...
    //public GameObjectCollection legolist;
    ...
    protected override void FollowTarget(float deltaTime)
    {
        ...
        Vector3 _offset = new Vector3(-4f, -1f, 10f);
        // camera position moves towards target position:
        //mainCam.transform.localPosition = Vector3.Lerp(mainCam.transform.localPosition, new Vector3(0f, 0f, -legolist.Count * .3f), .05f);
        transform.position = Vector3.Lerp(transform.position, m_Target.position + _offset, deltaTime * m_MoveSpeed);
